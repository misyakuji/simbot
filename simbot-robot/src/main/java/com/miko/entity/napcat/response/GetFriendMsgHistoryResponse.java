...
/**
 * 获取好友历史消息响应实体
 * 用于接收 /get_friend_msg_history 接口的返回结果
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
@Accessors(chain = true)
public class GetFriendMsgHistoryResponse implements Serializable {
    @Serial
     ...
     * 数据
     */
    private FriendMsgHistoryData data;
    ...
    @NoArgsConstructor
    @AllArgsConstructor
    public static class FriendMsgHistoryData {
        /**
         * 消息列表
         */
